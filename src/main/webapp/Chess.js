...
{
   var piece=document.getElementById(lastSelectPosition).innerText;
   var coin=document.getElementById(lastSelectPosition).getAttribute("name");

   document.getElementById(lastSelectPosition).innerText='';
   document.getElementById(lastSelectPosition).setAttribute("name","");


   document.getElementById( toPosition  ).innerText=piece;
   document.getElementById(toPosition).setAttribute("name",coin);
   ...
   if(  coin=="W_K" )
   {
         ...
         if( lastSelectPosition=="e1"  )
         {
                      if(  toPosition=="g1"  )
                      {
                        var whiteRook=document.getElementById("h1").innerText;

                                  document.getElementById("h1").innerText='';
                                  document.getElementById("h1").setAttribute("name","");

                                  document.getElementById( "f1"  ).innerText=whiteRook;
                                  document.getElementById("f1").setAttribute("name","W_R"); 
                                  whiteRookMovementAtH1++;
                      }

                      if(  toPosition=="c1"  )
                      {
                        var whiteRook=document.getElementById("a1").innerText;

                                  document.getElementById("a1").innerText='';
                                  document.getElementById("a1").setAttribute("name","");

                                  document.getElementById( "d1"  ).innerText=whiteRook;
                                  document.getElementById("d1").setAttribute("name","W_R"); 
   ...
   if(  coin=="B_K" )
   {
      if( lastSelectPosition=="e8"  )
      {
                   if(  toPosition=="g8"  )
                   {
                     var blackRook=document.getElementById("h8").innerText;

                               document.getElementById("h8").innerText='';
                               document.getElementById("h8").setAttribute("name","");

                               document.getElementById( "f8"  ).innerText=blackRook;
                               document.getElementById("f8").setAttribute("name","B_R"); 
                               blackRookMovementAtH8++;
                   }

                   if(  toPosition=="c8"  )
                   {
                     var blackRook=document.getElementById("a8").innerText;

                               document.getElementById("a8").innerText='';
                               document.getElementById("a8").setAttribute("name","");

                               document.getElementById( "d8"  ).innerText=blackRook;
                               document.getElementById("d8").setAttribute("name","W_R"); 
...
function getPawnMoves(position,coin,flag)
{
      ...
      if( coin.startsWith("W") )
      {
           ...
           if(  row<=8 && !isSameColourCoinHere(coin,col+""+row) &&  !isOppositeColourCoinHere( coin, col+""+row) )
           {
                 var toPosition=col+""+row;
                  ...
                  if( flag )
                  {
                     ...
                     document.getElementById(position).setAttribute( "name","" );
                     document.getElementById(toPosition).setAttribute( "name",coin );
                     ...
                     if(  !isWhiteKingCheck() )
                     {
                        ...
                        document.getElementById(position).setAttribute( "name",coin );
                        document.getElementById(toPosition).setAttribute( "name","" );
                  }
                  else
                  {
                     movingPlaces.push(toPosition);
           ...
           { 
                   ...
                   if( flag )
                   {
                       ...
                       document.getElementById(position).setAttribute( "name","" );
                       document.getElementById(col+""+4).setAttribute( "name",coin );
                        ...
                        document.getElementById(position).setAttribute( "name",coin );
                        document.getElementById(col+""+4).setAttribute( "name","" );
                  }
                  else
                  {
                     movingPlaces.push(toPosition);
                     ...
                     var row1=parseInt( position.charAt(1)+"" )+rowMoves[i] ;
                      ...
                      if(  row1<=8 && col1>='a' && col1<='h' &&  isOppositeColourCoinHere( coin,col1+""+row1 )  )
                      {
                              ...
                              if( flag )
                              {
                                   ...
                                   document.getElementById(position).setAttribute( "name",coin );
                                   document.getElementById(toPosition).setAttribute( "name",toCoin );
      ...
      if( coin.startsWith("B") )
      {
           ...
           if( row==6 &&  !isSameColourCoinHere(coin,col+""+row) &&  !isOppositeColourCoinHere( coin, col+""+row) && !isSameColourCoinHere(coin,col+""+5) &&  !isOppositeColourCoinHere( coin, col+""+5) )
           {
                     ...
                     {
                       document.getElementById(position).setAttribute( "name","" );
                       document.getElementById(col+""+5).setAttribute( "name",coin );
                        ...
                        document.getElementById(position).setAttribute( "name",coin );
                        document.getElementById(col+""+5).setAttribute( "name","" );
